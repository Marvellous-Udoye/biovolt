    ...
    <div className="px-4 pt-3">
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-6 max-w-2xl text-4xl font-medium leading-tight">
      ...
      <section className="px-0 pb-16">
        <div className="mx-auto max-w-6xl rounded-2xl bg-[#c9ddc8] px-7 py-12">
          <div className="text-center">
            <SectionLabel>Simulation evidence</SectionLabel>
            <h2 className="mt-5 text-3xl font-medium">AnyLogic and OpenModelica preview panels</h2>
