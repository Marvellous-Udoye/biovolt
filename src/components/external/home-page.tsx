  ...
  return (
    <div className="flex flex-col">
      <section className="px-4 pt-3">
        <div className="relative mx-auto min-h-[680px] max-w-6xl overflow-hidden rounded-2xl bg-[#0f4f12] md:min-h-[640px]">
          <ImageBlock src={images.hero} alt="Green hills with renewable energy infrastructure" className="absolute inset-0 size-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#225f47]/25 via-transparent to-[#063d08]/80" />
          <div className="absolute inset-x-0 bottom-0 grid gap-6 p-7 text-white md:grid-cols-[1.15fr_0.55fr_0.42fr] md:items-end md:p-11">
            <h1 className="max-w-md text-4xl font-semibold leading-[1.02] tracking-normal md:text-5xl">
            ...
            <div className="overflow-hidden rounded-xl border border-white/80 bg-white/10 p-1 backdrop-blur">
      ...
      <section id="about" className="mx-auto grid max-w-6xl gap-8 px-8 py-16 md:grid-cols-[0.6fr_1.4fr]">
        <SectionLabel>Who we are</SectionLabel>
        <div>
          <p className="max-w-3xl text-2xl leading-[1.15] text-[#656765] md:text-3xl">
          ...
          <div className="mt-9 grid max-w-3xl grid-cols-3 divide-x divide-[#e7e7df]">
            {[
              ["3.7", "kWh per m3 CH4"],
      ...
      <section id="services" className="px-4">
        <div className="mx-auto max-w-6xl rounded-2xl bg-[#c9ddc8] px-7 py-12 text-center">
          <SectionLabel>What we do</SectionLabel>
          <h2 className="mt-5 text-3xl font-medium">Our Services</h2>
      ...
      <section id="projects" className="mx-auto max-w-6xl px-8 py-16">
        <div className="grid gap-8 md:grid-cols-[0.9fr_1.1fr]">
          <div>
            <SectionLabel>Our projects</SectionLabel>
            <h2 className="mt-7 max-w-xs text-4xl leading-[1.05] font-medium">Our Portfolio of Projects</h2>
          </div>
          <div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {processCards.map((project) => (
            <article key={project.title} className="relative h-72 overflow-hidden rounded-lg bg-[#0c4d0e] text-white">
      ...
      <section className="px-4">
        <div className="mx-auto max-w-6xl rounded-2xl bg-[#074c08] px-7 py-14 text-center text-white">
          <SectionLabel>Why BioVolt</SectionLabel>
          <h2 className="mt-5 text-4xl font-medium">Why Choose Us?</h2>
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-8 py-16 md:grid-cols-[1.1fr_0.9fr]">
        <p className="max-w-xl text-xs leading-5 text-[#60665f]">
        ...
        <div>
          ...
          <h2 className="mt-7 text-4xl font-medium">Meet Our Experts</h2>
        </div>
        <div className="grid gap-6 md:col-span-2 md:grid-cols-3">
          {[images.teamOne, images.teamTwo, images.teamThree].map((image, index) => (
            <ImageBlock key={image} src={image} alt={`BioVolt team expert ${index + 1}`} className="h-80 w-full rounded-lg object-cover" />
          ))}
        </div>
      </section>

      <section className="mx-auto grid max-w-6xl gap-8 px-8 py-12 md:grid-cols-[0.9fr_1.1fr]">
        <div>
